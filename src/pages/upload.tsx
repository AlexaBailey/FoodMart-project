          ...
          <div>
            ...
            >
              ...
              <div className="selecti">
                <label>
                  <select
                    name="cat"
                    value={cat}
                    onChange={(event) => categoryHandle(event.target.value)}
                  >
                    <option id="0" onClick={() => setCat("")}>
                      Select category
                    </option>
              ...
              <button
                ...
                style={{ width: 120, marginTop: 18, alignSelf: "center" }}
